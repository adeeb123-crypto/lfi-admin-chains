...
const LaunchpadOption = (props) => {
	...
	const handleChangeFeeData = (name, index, feeOptionIndex) => (e) => {
		if (name === "fee") {
			details.currencies[index]["feeOption"][feeOptionIndex]["fee"] =
				e.target.value.match(/^([0-9]{1,})?(\.)?([0-9]{1,})?$/)
					? e.target.value
					: details.currencies[index]["feeOption"][feeOptionIndex][
							"fee"
					  ];
	...
	const currencyToggleItem = (e, index) => {
		e.preventDefault();
		details.currencies[index].active = !details.currencies[index].active;
		handleformData({
			...details,
			currencies: [...details.currencies],
		});
	...
	return (
		<React.Fragment>
			<div className="page-content">
				<Helmet>
					<title>Network Info | LFinance</title>
				</Helmet>
				<Container fluid>
					{/* Render Breadcrumbs */}
										...
										<Col xl="12">
											<div className="table-rep-plugin">
												<div className="table-responsive">
													...
													>
														<ReactDataTable
															url={`${apiUrl}/admin/network-info/pagination`}
															columns={columns()}
															resultFormatter={
																resultFormatter
															}
																			...
																			<div>
																				<div className="mb-3">
																					<div className="col-auto">
																						...
																						<button
																							type="button"
																							className="m-1 btn btn-soft-primary waves-effect waves-light"
																							onClick={
																								addCurrency
																							}
																						>
